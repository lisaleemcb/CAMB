...
class TanhReionization(ReionizationModel):
    ...
    _fields_ = [
        ...
        ("include_heliumI_fullreion", c_bool, "Whether to include second reionization of helium"),
        ("include_heliumII_fullreion", c_bool, "Whether to include second reionization of helium"),
        ("heliumI_redshift", c_double, "Redshift for first reionization of helium"),
        ("heliumII_redshift", c_double, "Redshift for second reionization of helium"),
        ("heliumI_delta_redshift", c_double, "Width in redshift for first reionization of helium"),
        ("heliumII_delta_redshift", c_double, "Width in redshift for second reionization of helium"),
        ("heliumI_redshiftstart", c_double, "Include first helium reionizatio below this redshift"),
        ("heliumII_redshiftstart", c_double, "Include second helium reionizatio below this redshift"),
