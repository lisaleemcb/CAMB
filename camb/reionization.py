...
class TanhReionization(ReionizationModel):
    ...
    _fields_ = [
        ...
        ("zre_H", c_double, "Reionization redshift if use_optical_depth-False"),
        ("optical_depth", c_double, "Optical depth if use_optical_depth=True"),
        ("dz_H", c_double, "Duration of reionization"),
        ("fraction", c_double,
         "Reionization fraction when complete, or -1 for full ionization of hydrogen and first ionization of helium."),
        ("include_HeI", c_bool, "Whether to include second reionization of helium"),
        ("include_HeII", c_bool, "Whether to include second reionization of helium"),
        ("zre_HeI", c_double, "Redshift for first reionization of helium"),
        ("zre_HeII", c_double, "Redshift for second reionization of helium"),
        ("dz_HeI", c_double, "Width in redshift for first reionization of helium"),
        ("dz_HeII", c_double, "Width in redshift for second reionization of helium"),
        ("zre_HeI_start", c_double, "Include first helium reionizatio below this redshift"),
        ("zre_HeII_start", c_double, "Include second helium reionizatio below this redshift"),
        ...
        ("zend_H", c_double, "End redshift of hydrogen reionization for aysm model"),
        ("zend_HeI", c_double, "End redshift of helium I reionization for aysm model"),
